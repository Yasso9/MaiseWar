...
public class GameMenuState implements IState {
    ...
    public void init() {
        ...
        menuBox = new GameObject2D("menu", 128, 100, scene.getCamera().getTranslateX() + 64, scene.getCamera().getTranslateY() - 192);
    ...
    public void draw() {
        ...
        graphicsContext.fillText("Main Menu", menuBox.getX() + 32, menuBox.getY() + 32);
        graphicsContext.fillText("Quit Game", menuBox.getX() + 32, menuBox.getY() + 64);
